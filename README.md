...
Calculate $R_g$ Minimum from the $I_OL$ Peak Specification. The IGBT and $R_g$ can be analyzed as a simple RC circuit with a voltage supplied by the HCPL-3120.
